...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ca_question', (
            ('question_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ...
        db.create_table(u'ca_package', (
            ('package_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ...
        db.create_table(u'ca_university', (
            ...
            ('enrollment', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.create_table(u'ca_program', (
            ('program_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ...
        db.create_table(u'ca_resume', (
            ('resume_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ...
        db.create_table(u'ca_ps', (
            ('ps_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ca.User'])),
        ...
        db.create_table(u'ca_lor', (
            ('lor_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ca.User'])),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        ...
        db.create_table(u'ca_bs', (
            ('bs_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
